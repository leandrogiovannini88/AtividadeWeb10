                    ...
                    <form action="Controller.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="tel" class="form-control" name="populacao" id="populacao" maxlength="15"  placeholder="999999999" value="${pais.populacao }">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="area">Area</label>
                                <input type="area" class="form-control" name="area" id="area" required maxlength="60" placeholder="area obrigatório" value="${pais.area }">
                            </div>
                        </div>
                        <hr />
